...
//	get all user
    ...
    public ResponseEntity<List<User>> getAllProducts() {
	 ...
	 @PutMapping("/{username}")
	    public ResponseEntity<User> updateProduct(@PathVariable String username, @RequestBody User updatedUser) throws UserNotFoundException {
	        try {
	    ...
	    public ResponseEntity<Void> deleteProductById(@PathVariable String username) throws UserNotFoundException {
	        try {
